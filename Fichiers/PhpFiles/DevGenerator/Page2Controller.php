...
class Page2Controller extends Controller
{
    ...
    public function create(Request $request)
    {
        $request->validate([
          ...
          $crudPart = new \Hoggar\Hoggar\Utils\WizardPart();
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////
          ...
          $sourcePath = base_path('vendor/hoggar/hoggar/Fichiers/WizardFiles');
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('HoggarPages/DevGenerator/Page2', [
